          ...
          <div className="p-6 space-y-4   md:space-y-6 sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6" action="#">
                  <div className='flex items-start flex-col'>
                      ...
                      <input type="text" name="email"  onChange={handleUserInput} id="email" className=" border rounded-lg   block w-full p-3 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Entrez votre numéro de téléphone" />
                  </div>
                  <div className='flex items-start flex-col'>
                      <label  className="block mb-2 text-sm font-medium text-white">Mot de passe</label>
                      <input type="password" onChange={handlePwdInput} name="password" id="password" placeholder="Entrez votre mot de passe"  className=" border rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-3 bg-gray-700 border-gray-600 placeholder-gray-400 dark:text-white focus:ring-blue-500 focus:border-blue-500"  />
                  </div>
                  ...
                  <button disabled={isLoading} type="submit" className={`w-full ${isLoading ? "bg-blue-400 cursor-wait" : ""} text-white bg-blue-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800`}>{isLoading ? "Loading..." : "Connexion" }</button>
